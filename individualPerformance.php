...
{
array_push($campaignData,(object) array("name" => $row["Name"],"goalsPercentage" => $row["Goals"]*100, "attendancePercentage" => $row["Attendance"], "weightLoss" => $row["Weight_loss"],"finalWeight" => $row["Final_weight"] ,"targetWeight" => $row["Target_weight"],"dropout" => $row["Dropout"],"march" => $row["March"],"april" => $row["April"],"may" => $row["May"],"gender" => $row["Gender"]));
...
<br>
<br>
 <p><img src="cal.png" width="30px">
<font face=" Comic Sans MS">Number of spanning record by monthly</p>
...
<p id="may" style="color:white"align="center"align="right" ><b>May:</b></p>
  ...
  function generateGraph(participantData){
	...
	document.getElementById('gender').innerHTML = "Gender: " + participantData.gender;
